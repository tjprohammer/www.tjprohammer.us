...
const AlpineProductPage = () => {
    const { thehighalpineId } = useParams();
    const { mountainProducts } = ProductState();

    const thisproduct = mountainProducts.find((prod) => prod.title === thehighalpineId);
...
export default AlpineProductPage;
